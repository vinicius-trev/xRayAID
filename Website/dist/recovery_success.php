...
<head>
    ...
    <title>xRayAID - Recovery Success</title>
                            ...
                            <div class="col-lg-6  align-self-center">
                                <div class="card shadow-lg border-0 rounded-lg mt-6">
                                    <div class="card-header">
                                        <h3 class="text-center font-weight-light my-4">Sucesso</h3>
                                    </div>
                                    <div class="card-body">
                                    <div class="small mb-3 text-muted text-center">
                                        ...
                                        <div class="text-center font-weight-light" style="color:green; font-size:0.9em">
                                            <p>Prontinho, sua senha foi alterada com sucesso.</p>
                                        </div>

                                        <a href="https://xrayaid.com.br" class="btn btn-primary btn-block" >Voltar para Homepage</a>
                                    </div>
